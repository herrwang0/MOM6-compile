...
INCLUDES = -I${I_MPI_ROOT}/intel64/include -I${NF_INCLUDE}
...
FFPPLAGS += -I${I_MPI_ROOT}/intel64/include 
...
FFLAGS_OPT = -O2
FFLAGS_REPRO = -I${I_MPI_ROOT}/intel64/include -O2
...
CPPFLAGS += -Xlinker --enable-new-dtags -Xlinker -rpath -Xlinker ${I_MPI_ROOT}/intel64/lib/release_mt -Xlinker -rpath -Xlinker ${I_MPI_ROOT}/intel64/lib -Xlinker -rpath -Xlinker /opt/intel/mpi-rt/2017.0.0/intel64/lib/release_mt -Xlinker -rpath -Xlinker /opt/intel/mpi-rt/2017.0.0/intel64/lib -lmpifort -lmpi -lmpigi -ldl -lrt -lpthread 

# Base set of C compiler flags
CFLAGS := -sox -traceback -I${I_MPI_ROOT}/intel64/include -I${NF_INCLUDE}
